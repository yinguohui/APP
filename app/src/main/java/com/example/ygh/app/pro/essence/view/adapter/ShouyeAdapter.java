...
public class ShouyeAdapter extends XRecyclerView.Adapter implements View.OnClickListener {
    ...
    public ShouyeAdapter(List<PostsListBean.Info.PostList> list, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_essence_video_layout,viewGroup,false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof ViewHolder) {
            ...
            if (!postList.getTitle_img().equals("")){
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case  R.id.ll_forword:
                ToastUtil.showToast(context,"分享加+1");
                break;
        }
    }
