...
import com.example.ygh.app.pro.newpost.view.adapter.CityListAdapter;
import com.example.ygh.app.pro.newpost.view.views.SideLetterBar;
...
public class CityActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        TextView tv_letter_overlay = (TextView) findViewById(R.id.tv_letter_overlay);
        sideLetterBar.setOverlay(tv_letter_overlay);

        String[] letters = {"A", "阿坝", "阿拉善", "阿里", "安康", "安庆", "鞍山", "安顺", "安阳", "澳门", "B", "北京", "白银",
        ...
        for (int i = 0; i < letters.length; i++) {
            cityList.add(letters[i]);
        }

        lv_city = (RecyclerView) findViewById(R.id.lv_city);
        LinearLayoutManager layoutManager = new LinearLayoutManager(this);
        layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        lv_city.setLayoutManager(layoutManager);

        cityListAdapter = new CityListAdapter(this, cityList, SpUtil.getString(this, "CITY", "") + "市");
        ...
        sideLetterBar.setOnLetterChangedListener(new SideLetterBar.OnLetterChangedListener() {
            ...
            public void onLetterChanged(String letter) {
                ...
                ((LinearLayoutManager) lv_city.getLayoutManager()).scrollToPositionWithOffset(position, 0);
            }
        });
    }
}
