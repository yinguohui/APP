package com.example.ygh.app.pro.publish.view.adapter;
...
import com.example.ygh.app.bean.ImageItem;
import com.example.ygh.app.util.Bimp;
import com.example.ygh.app.util.BitmapCache;
...
public class ImageGridAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (item.isSelected) {
			...
			holder.selected.setImageResource(R.drawable.ic_delete_photo);
