...
public class MyTicketsAdapter extends RecyclerView.Adapter{
    ...
    public MyTicketsAdapter(Context context, List<TicketResult.TicketInfo> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_mytickets, parent, false);
